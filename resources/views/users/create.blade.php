...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <a href="{{ route('users.index') }}" class="text-blue-600 hover:text-blue-800">← Назад к списку</a>
        </div>
            ...
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="relative">
                            <div id="avatarPreview" class="h-20 w-20 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold">
                                U
                            </div>
                        ...
                        <input type="file" id="avatar" name="avatar_path" class="hidden" accept="image/*">
                        <div class="text-sm text-gray-500">
                            Нажмите на иконку, чтобы загрузить фото
                        </div>
                    </div>
                    ...
                    <!-- Телефоны -->
                    <div x-data="{ phones: [{ number: '', primary: false }] }">
                        ...
                        <button type="button"
                                @click="phones.push({ number: '', primary: false })"
